...
<template>
  <section class="bg-white">
    <div
      class="mx-auto max-w-6xl px-6 py-12 text-center flex flex-col items-center"
    >
      <div
        class="mb-1 transition-transform duration-300 hover:scale-105 active:scale-95"
      >
        <img
          :src="serviceLogo"
          alt="SSAFY 모여유 로고"
      ...
      <p
        class="mx-auto mt-4 max-w-2xl text-pretty text-lg leading-relaxed text-ink/70"
      >
        모각코·CS 스터디부터 프로젝트 팀원, 점심 메이트, 러닝까지. 같은 기수
        동료들과 번개로 모여요.
      </p>
    </div>
  </section>
  ...
  <section class="mx-auto max-w-6xl px-6 py-12">
    ...
    <div class="grid gap-6 md:grid-cols-12 items-stretch">
      ...
      <div
        class="md:col-span-7 grid gap-4 grid-cols-1 sm:grid-cols-2 content-start"
      >
